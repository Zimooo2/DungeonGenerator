...
namespace Natural_Language_Processing_Tset
{
    ...
    {
        private const string jarRoot = @"stanford-corenlp-3.7.0-models";
        private const string modelsDirectory = jarRoot + @"\models";
        private const string taggerFile = @"\wsj-0-18-bidirectional-nodistsim.tagger";
        private MaxentTagger tagger;

        public POSFinder()
        {           
            // Loading POS Tagger
            this.tagger = new MaxentTagger(POSFinder.modelsDirectory + POSFinder.taggerFile);
        }
        ...
        public List<string> FindAdjective(string text)
        {
